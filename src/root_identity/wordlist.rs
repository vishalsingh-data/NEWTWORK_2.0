// Minimal 256-word list for demo purposes.
// Replace with full BIP39 wordlist for real production use.
pub const WORDS: [&str; 256] = [
    ...
    "cattle","caught","cause","caution","cave","ceiling","celery","cement","census","cent",
    "center","central","century","cereal","certain","chair","chalk","champion","change","chaos",
